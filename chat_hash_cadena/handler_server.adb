...
-------------------------------------------------------------------------------
   function Natural_Hash (U: ASU.Unbounded_String) return Hash_Range is
   begin
      return Hash_Range'Mod(U);
   end Natural_Hash;
----------------------falta perfecionar la funcion hash para que de
-- la suma del valor numerico de cada caracter del Unbounded_String
